...
public class CityEntity {
    ...
    @Basic
    @Column(name = "Name", nullable = false, insertable = true, updatable = true, length = 35, precision = 0)
    ...
    @Basic
    @Column(name = "District", nullable = false, insertable = true, updatable = true, length = 20, precision = 0)
